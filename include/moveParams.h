...
#define P_DIST           25.3             // P_DIST * distance of current goal and endpoint = forward motor vel; usually from 0-40
#define P_ANG            12.5             // P_ANG * curvature of arc = turning motor vel; usually from 0 - 1
#define CP_ANG           12.5
...
#define KP_ANG          12.5            // P parameter between current angle and target angle from motion profiling
#define KI_ANG          7.32
