  ...
  return (
      <div className="absolute items-center justify-items-center min-h-screen font-[family-name:var(--font-geist-sans)] h-full w-full p-4">
        <div className="grid grid-cols-8 grid-rows-8 gap-4 w-full h-full">
          <div className="col-span-2 row-span-7 p-4 border-white w-full h-full border-neutral-600 border-2 rounded-xl">
          ...
          <div className="col-span-4 row-span-7 min-w-[300px] p-4 border-white w-full h-full border-neutral-600 border-2 rounded-xl flex justify-center flex-col items-center">
            <Map imageUrl="regularField.png" />
          </div> 
          <div className="col-span-2 row-span-8 min-w-[300px] p-4 border-white w-full h-full border-neutral-600 border-2 rounded-xl overflow-y-auto">
            <h1 className="font-bold text-[20px] mb-6 w-full text-center">Default Forward/Backward Params</h1>  
            ...
            <h1 className="font-bold text-[20px] my-6 w-full text-center">Default Point Turn Params</h1>  
          ...
          <div className="col-span-6 row-span-1 min-w-[300px] p-4 border-neutral-600 w-full h-full border-white border-2 rounded-xl">
